            ...
            <div class="footer-inner">
                <div class="footer-social">
                    ...
                    <div class="icons">
                        ...
                        <a href="https://www.youtube.com/c/SRKREC" target='_new'><i class="fa fa-youtube-play"></i></a>
                    </div><!-- /.icons -->
                </div><!-- /.social -->
                ...
                <div class="col-md-3 col-sm-3">
                    <aside>
                        ...
                        <ul class="list-links">
                            ...
                            <li><a href="grievance.php" target='_new'>Online Grievance</a></li> 
                ...
                <div class="col-md-3 col-sm-3">
                    <aside>
                        ...
                        <ul class="list-links">
                            ...
                            <li><a href="best_practices.php">Best Practices of the Institution</a></li>
                            <li><a href="organogram.php">Organogram</a></li>
                            <li><a href="distinctiveness.php">Institute’s Distinctiveness</a></li>
                            <li><a href="strategic_plan.php">Strategic Plan &amp; Deployment</a></li>
                            <li><a href="feedback_curriculum.php">Feedback on Curriculum</a></li>
                            <li><a href="gender_sensitisation_plan.php">Annual Gender Sensitisation Plan</a></li>
                        </ul>
                    </aside>
                </div><!-- /.col-md-3 -->
                <div class="col-md-3 col-sm-3">
